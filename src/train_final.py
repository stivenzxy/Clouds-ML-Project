...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        # Checkpoint según F1 macro de validación.
        if f1_m > best_f1:
            best_f1 = f1_m
            best_epoch = epoch
            epochs_no_improve = 0
    ...
    history_df.to_csv('results/training_history_final.csv', index=False)
    print("Historial de entrenamiento guardado en: results/training_history_final.csv")
